...
export const ArtCreateView = () => {
  ...
  const [attributes, setAttributes] = useState<MetadataExtension>({
    name: '',
    symbol: '',
    collection: '',
    description: '',
    ...
    isDynamicCharmanderPokemon: false,
  });
    ...
    <>
      <Row className={'creator-base-page'} style={{paddingTop: 50}}>
        ...
        <Col span={24} {...(stepsVisible ? {md: 20} : {md: 24})}>
          {step === 0 && (
            <CategoryStep
              confirm={(category: MetadataCategoryChoice) => {
                setAttributes({
                  ...attributes,
                  properties: {
                  ...
                  category.isDynamicCharmanderPokemon,
                });
                if (
          ...
          {0 < step && step < 5 && (
            <div style={{margin: 'auto', width: 'fit-content'}}>
              <Button
                onClick={() =>
                  gotoStep(
                    step === 2 && attributes.isDynamicCharmanderPokemon
                      ? step - 2
                      : step - 1,
                  )
                }
...
const CategoryStep = (props: {
  confirm: (category: MetadataCategoryChoice) => void;
}) => {
  const {width} = useWindowDimensions();
  return (
    <>
          ...
          <Row>
            <Button
              ...
              onClick={() =>
                props.confirm({
                  category: MetadataCategory.Image,
                  isDynamicCharmanderPokemon: true,
                })
              }
            >
              <div>
                <div>Dynamic Charmander Pokemon</div>
                <div className="type-btn-description">
                  Pokemon that can be evolved dynamically
                </div>
              </div>
            </Button>
          </Row>
...
const UploadStep = (props: {
  attributes: MetadataExtension;
  setAttributes: (attr: MetadataExtension) => void;
  files: File[];
...
const useArtworkFiles = (files: File[], attributes: MetadataExtension) => {
  ...
  return (
    <>
      ...
      <Row className="content-action" justify="space-around">
        <Col>
          {(props.attributes.isDynamicCharmanderPokemon ||
            ...
            <ArtCard
              ...
              artView={
                !(
                  props.files.length >
                  1 + (props.attributes.isDynamicCharmanderPokemon ? 1 : 0)
                )
              }
...
const Congrats = (props: {
  ...
  const isDataLoading = loading || isLoading || isFetching;
  ...
  return (
    <>
      ...
      {isDataLoading ? <div className="congrats-button-container">
          <div style={{textAlign: "center"}}><SmallLoader/></div>
